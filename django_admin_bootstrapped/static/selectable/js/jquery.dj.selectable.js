...
(function ($) {
    ...
    window.bindSelectables = function (context) {
        ...
        */
        // Remove old djselectable
        var data = $(":input[data-selectable-type=text]", context).data();
        if (data && data["djselectable"])
            delete data["djselectable"];
        var data = $(":input[data-selectable-type=combobox]", context).data();
        if (data && data["djselectable"])
            delete data["djselectable"];
